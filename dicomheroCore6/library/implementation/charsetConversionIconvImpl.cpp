...
charsetConversionIconv::charsetConversionIconv(const charsetInformation& charsetInformation)
{
    ...
    {
        DICOMHERO_THROW(CharsetConversionNoSupportedTableError, "Table " << charsetInformation.m_isoRegistration << " for DICOM charset " << charsetInformation.m_dicomName << " not supported by the system");
    }
