...
///
///////////////////////////////////////////////////////////////////////////////
class DICOMHERO_API MutableDicomDirEntry: public DicomDirEntry
{
...
protected:
    explicit MutableDicomDirEntry(const std::shared_ptr<dicomhero::implementation::directoryRecord>& pDirectoryRecord);
