...
#ifndef SWIG
protected:
    explicit Tag(const std::shared_ptr<dicomhero::implementation::data>& pData);

private:
    friend const std::shared_ptr<dicomhero::implementation::data>& getTagImplementation(const Tag& tag);
    std::shared_ptr<dicomhero::implementation::data> m_pData;
#endif
};
...
///
///////////////////////////////////////////////////////////////////////////////
class DICOMHERO_API MutableTag: public Tag
{
...
protected:
    explicit MutableTag(const std::shared_ptr<dicomhero::implementation::data>& pData);
};
