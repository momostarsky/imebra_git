...
#import "../include/dicomhero6_objc/dicomhero_serialNumberUidGenerator.h"
#include "dicomhero_implementation_macros.h"
#include "dicomhero_nserror.h"
#include "dicomhero_strings.h"
#include <dicomhero6/serialNumberUidGenerator.h>

@implementation DicomheroSerialNumberUIDGenerator
...
-(id)initWithRoot:(NSString*)root departmentId:(unsigned int)departmentId modelId:(unsigned int)modelId serialNumber:(unsigned int)serialNumber
{
    ...
    if(self)
    {
        set_dicomhero_object_holder(BaseUIDGenerator, new dicomhero::SerialNumberUIDGenerator(
