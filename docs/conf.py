# -*- coding: utf-8 -*-
#
# Imebra documentation build configuration file, created by
...
project = u'Imebra'
copyright = u'2016, Paolo Brandoli'
...
release = version + '.' + str(hgprocess.stdout.readlines()[0].count(b'.'))
...
latex_documents = [
  ('index', 'Imebra.tex', u'Imebra Documentation',
...
epub_copyright = u'2016, Paolo Brandoli'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'Imebra'
