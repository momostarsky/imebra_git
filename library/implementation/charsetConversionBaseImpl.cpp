...
const charsetInformation& charsetDictionary::getCharsetInformation(const std::string& dicomName, size_t variant) const
{
    IMEBRA_FUNCTION_START();
...
void charsetDictionary::registerCharset(const std::string& dicomName, const std::string& isoName, const std::string& javaName, const unsigned long windowsPage, const bool bZeroFlag)
{
    IMEBRA_FUNCTION_START();
