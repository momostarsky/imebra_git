...
#ifndef SWIG
protected:
    explicit DataSet(const std::shared_ptr<dicomhero::implementation::dataSet>& pDataSet);

private:
    friend const std::shared_ptr<implementation::dataSet>& getDataSetImplementation(const DataSet& dataSet);
    std::shared_ptr<dicomhero::implementation::dataSet> m_pDataSet;
#endif
};
...
///
///////////////////////////////////////////////////////////////////////////////
class DICOMHERO_API MutableDataSet: public DataSet
{
...
protected:
    explicit MutableDataSet(const std::shared_ptr<dicomhero::implementation::dataSet>& pDataSet);
