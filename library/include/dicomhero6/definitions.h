...
// Generic helper definitions for shared library support
  ...
  #define DICOMHERO_HELPER_DLL_IMPORT __declspec(dllimport)
  #define DICOMHERO_HELPER_DLL_EXPORT __declspec(dllexport)
  #pragma warning(disable: 4275)
  #pragma warning(disable: 4251)
#else
  #if __GNUC__ >= 4
    #define DICOMHERO_HELPER_DLL_IMPORT __attribute__ ((visibility ("default")))
    #define DICOMHERO_HELPER_DLL_EXPORT __attribute__ ((visibility ("default")))
  #else
    #define DICOMHERO_HELPER_DLL_IMPORT
    #define DICOMHERO_HELPER_DLL_EXPORT
  #endif
#endif

// DICOMHERO_API is used for the public API symbols

#ifdef DICOMHERO_DLL // defined if Imebra is compiled as a DLL
  #ifdef DICOMHERO_DLL_EXPORTS // defined if we are building the Imebra DLL (instead of using it)
    #define DICOMHERO_API DICOMHERO_HELPER_DLL_EXPORT
  #else
    #define DICOMHERO_API DICOMHERO_HELPER_DLL_IMPORT
  #endif // DICOMHERO_DLL_EXPORTS
#else // DICOMHERO_DLL is not defined: this means Imebra is a static lib.
  #define DICOMHERO_API
#endif // DICOMHERO_DLL

#ifndef DICOMHERO_IMPLEMENTATION_CLASS_UID
#define DICOMHERO_IMPLEMENTATION_CLASS_UID "1.3.6.1.4.1.54308.2.1.1.4"
#endif
