...
#ifndef SWIG
protected:
    explicit Image(const std::shared_ptr<dicomhero::implementation::image>& pImage);
...
///
///////////////////////////////////////////////////////////////////////////////
class DICOMHERO_API MutableImage: public Image
{
...
protected:
    explicit MutableImage(std::shared_ptr<dicomhero::implementation::image> pImage);
