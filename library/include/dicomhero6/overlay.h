...
#ifndef SWIG
protected:
    explicit Overlay(const std::shared_ptr<dicomhero::implementation::overlay>& pOverlay);
...
///
///////////////////////////////////////////////////////////////////////////////
class DICOMHERO_API MutableOverlay: public Overlay
{
...
protected:
    explicit MutableOverlay(std::shared_ptr<dicomhero::implementation::overlay> pOverlay);
