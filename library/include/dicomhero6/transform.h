...
#ifndef SWIG
protected:
    explicit Transform(const std::shared_ptr<dicomhero::implementation::transforms::transform>& pTransform);

private:
    friend const std::shared_ptr<dicomhero::implementation::transforms::transform>& getTransformImplementation(const Transform& transform);
    std::shared_ptr<dicomhero::implementation::transforms::transform> m_pTransform;
#endif
};
