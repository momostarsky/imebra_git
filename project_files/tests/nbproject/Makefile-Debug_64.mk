...
# Object Directory
OBJECTDIR=build/Debug_64/GNU-Linux-x86
...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/Debug_64/GNU-Linux-x86/tests

dist/Debug_64/GNU-Linux-x86/tests: ${OBJECTFILES}
	${MKDIR} -p dist/Debug_64/GNU-Linux-x86
	${LINK.cc} -o dist/Debug_64/GNU-Linux-x86/tests ${OBJECTFILES} ${LDLIBSOPTIONS} 
