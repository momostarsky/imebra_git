...
TEST(ageStringHandlerTest, ageTest)
{
    ...
    dataSet.setAge(0x0010, 0, 0x1010, 0, Age(3, imebra::ageUnit_t::days));
    ...
    ASSERT_THROW(dataSet.setDouble(0x0010, 0, 0x1010, 0, .01), imebra::DataHandlerDeniedConversionError);

    ASSERT_THROW(dataSet.setUnsignedLong(0x0010, 0, 0x1010, 0, 1), imebra::DataHandlerDeniedConversionError);

    ASSERT_THROW(dataSet.setSignedLong(0x0010, 0, 0x1010, 0, 1), imebra::DataHandlerDeniedConversionError);

    ASSERT_THROW(dataSet.setDate(0x0010, 0, 0x1010, 0, imebra::Date(2000, 1, 1, 0, 0, 0, 0, 0, 0)), imebra::DataHandlerDeniedConversionError);

    dataSet.setString(0x0010, 0, 0x1010, 0, "005M");
