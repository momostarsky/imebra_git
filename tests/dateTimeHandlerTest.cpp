...
TEST(dateTimeHandlerTest, dateTimeTest)
{
    ...
    Date checkDate = testDataSet.getDate(0x0008, 0, 0x002A, 0, 0);
    ...
    EXPECT_EQ(L"20041105092040.005000+0102", testDataSet.getString(0x0008, 0, 0x002A, 0, 0));
}
...
TEST(dateTimeHandlerTest, incompleteDateTimeTest)
{
    ...
    checkDate = testDataSet.getDate(0x0008, 0, 0x002A, 0, 0);
