...
TEST(numericHandlerTest, testDouble)
{
    for(size_t scanVR(0); scanVR != sizeof(floatTags) / sizeof(tagVR_t); ++scanVR)
    {
        ...
        ASSERT_THROW(testDataSet.getUnsignedLong(TagId(10, 10), 9), DataHandlerConversionError);
        ...
        ASSERT_THROW(testDataSet.getSignedLong(TagId(10, 10), 20), MissingItemError);
        ...
        ASSERT_THROW(testDataSet.getUnsignedLong(TagId(10, 10), 20), MissingItemError);
...
{
    {
        ...
        ASSERT_EQ(std::numeric_limits<std::uint8_t>::max(), testDataSet.getUnsignedLong(TagId(0x10, 0x10), 0));
        ...
        ASSERT_EQ(std::numeric_limits<std::uint8_t>::max(), testDataSet.getSignedLong(TagId(0x10, 0x10), 0));
        ...
        ASSERT_EQ(1u, testDataSet.getUnsignedLong(TagId(0x10, 0x10), 0));
        ASSERT_EQ(1, testDataSet.getInt8(TagId(0x10, 0x10), 0));
        ASSERT_EQ(1, testDataSet.getInt16(TagId(0x10, 0x10), 0));
        ASSERT_EQ(1, testDataSet.getSignedLong(TagId(0x10, 0x10), 0));
...

    {
        ...
        ASSERT_EQ(std::numeric_limits<std::uint16_t>::max(), testDataSet.getUnsignedLong(TagId(0x10, 0x10), 0));
        ...
        ASSERT_EQ(std::numeric_limits<std::uint16_t>::max(), testDataSet.getSignedLong(TagId(0x10, 0x10), 0));
...

    {
        ...
        ASSERT_EQ(static_cast<std::uint16_t>(std::numeric_limits<std::int16_t>::max()), testDataSet.getUnsignedLong(TagId(0x10, 0x10), 0));
        ...
        ASSERT_EQ(std::numeric_limits<std::int16_t>::max(), testDataSet.getSignedLong(TagId(0x10, 0x10), 0));
...

    {
        ...
        ASSERT_EQ(std::numeric_limits<std::uint32_t>::max(), testDataSet.getUnsignedLong(TagId(0x10, 0x10), 0));
        ...
        ASSERT_THROW(testDataSet.getInt8(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_THROW(testDataSet.getInt16(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_THROW(testDataSet.getSignedLong(TagId(0x10, 0x10), 0), DataHandlerConversionError);
...

    {
        ...
        ASSERT_THROW(testDataSet.getUint8(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_THROW(testDataSet.getUint16(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_EQ(static_cast<std::uint32_t>(std::numeric_limits<std::int32_t>::max()), testDataSet.getUnsignedLong(TagId(0x10, 0x10), 0));
        ...
        ASSERT_THROW(testDataSet.getInt8(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_THROW(testDataSet.getInt16(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_EQ(std::numeric_limits<std::int32_t>::max(), testDataSet.getSignedLong(TagId(0x10, 0x10), 0));
...

    {
        ...
        ASSERT_THROW(testDataSet.getUint8(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_THROW(testDataSet.getUint16(TagId(0x10, 0x10), 0), DataHandlerConversionError);
        ASSERT_THROW(testDataSet.getUnsignedLong(TagId(0x10, 0x10), 0), DataHandlerConversionError);
