...
#import "../include/dicomhero6_objc/imebra_drawBitmap.h"
...
#endif
{
    ...
    //////////////////////////
    std::unique_ptr<dicomhero::Memory> pMemory(new dicomhero::Memory(get_dicomhero_object_holder(DrawBitmap)->getBitmap(*get_other_imebra_object_holder(pImage, Image), dicomhero::drawBitmapType_t::drawBitmapRGBA, 4)));
    size_t dataSize;
